					...
					<c:when test="${requestType == '1'}">
						<c:forEach items="${HotelList}" var="Hotel">
							<div class="col-sm-6 col-md-4">
								<div class="thumbnail">
									<a href="getDeleteHotelPage.html?hotelId=${Hotel.id}"> <img
										id="close" alt="delte"
										src="https://cdn0.iconfinder.com/data/icons/round-ui-icons/512/close_red.png" /></a>
									<img src="${Hotel.photoPath}" alt="${Hotel.name }">
									<div class="caption">
										<h3>${Hotel.name }</h3>
